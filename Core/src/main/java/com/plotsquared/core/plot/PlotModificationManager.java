...
public interface PlotModificationManager {
     ...
     */
    CompletableFuture<Boolean> copy(final @NonNull Plot destination, @Nullable PlotPlayer<?> actor);
     ...
     */
    void setBiome(final @Nullable BiomeType biome, final @NonNull Runnable whenDone);
     ...
     */
    @NonNull CompletableFuture<Boolean> move(
